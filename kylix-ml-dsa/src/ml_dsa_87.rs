...
mod tests {
    ...
    fn test_expanded_verify_wrong_message() {
        ...
        let result = MlDsa87::verify_expanded(&expanded, wrong_message, &signature);
    ...
    fn test_expanded_verify_multiple_signatures() {
        ...
        for i in 0..5 {
            ...
            let signature = MlDsa87::sign(&sk, message.as_bytes()).unwrap();
            let result = MlDsa87::verify_expanded(&expanded, message.as_bytes(), &signature);
